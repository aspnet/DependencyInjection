...
//            var serviceTable = new ServiceTable(new[] { descriptor });

//            // Act and Assert
//            var ex = Assert.Throws<InvalidOperationException>(() => serviceTable.GetCallSite(type, new HashSet<Type>()));
...
//            // Act
//            var callSite = serviceTable.GetCallSite(type, new HashSet<Type>());
...
//            // Act
//            var callSite = serviceProvider.GetCallSite(type, new HashSet<Type>());
...
//            new TheoryData<Type, ServiceTable, Type[]>
//            {
//                {
...
//            new TheoryData<ServiceTable, Type[]>
//            {
//                {
//                    GetServiceProvider(
...
//            // Act and Assert
//            var ex = Assert.Throws<InvalidOperationException>(
//                () => serviceProvider.GetCallSite((ServiceProvider)serviceProvider, new HashSet<Type>()));
//            Assert.Equal(expectedMessage, ex.Message);
//        }
...
//            // Act and Assert
//            var ex = Assert.Throws<InvalidOperationException>(
//                () => serviceProvider.GetCallSite(type, new HashSet<Type>()));
//            Assert.StartsWith(expectedMessage, ex.Message);
//        }

//        private static ServiceTable GetServiceProvider(params ServiceDescriptor[] descriptors)
//        {
...
//            return new ServiceTable(collection.ToArray());
//        }
