...
namespace Microsoft.Extensions.DependencyInjection.Tests
{
    public class CallSiteTests
    {
        ...
        {
            var provider = new DefaultServiceProvider(descriptors, validateScopes: true);
        ...
        private static object Invoke(IServiceCallSite callSite, DefaultServiceProvider provider)
        {
            return CallSiteRuntimeResolver.Resolve(callSite, provider);
        }

        private static Func<DefaultServiceProvider, object> CompileCallSite(IServiceCallSite callSite)
        {
