...
namespace Microsoft.Extensions.DependencyInjection.Tests
{
    public class CallSiteTests
    {
        ...
        {
            var provider = new ServiceProviderEngine(descriptors, new ServiceProviderOptions { ValidateScopes = true });
        ...
        public void BuildExpressionAddsDisposableCaptureForDisposableServices(ServiceLifetime lifetime)
        {
            ...
            var provider = new ServiceProviderEngine(descriptors, ServiceProviderOptions.Default);
        ...
        {
            return new CallSiteExpressionBuilder(CallSiteRuntimeResolver).Build(callSite, engine.Root);
        }
    }
}
